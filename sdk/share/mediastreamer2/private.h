...
MEDIASTREAMER2_INTERNAL_EXPORT RtpSession * create_duplex_rtpsession(int loc_rtp_port, int loc_rtcp_port, bool_t ipv6, bool_t use_multicast);
MEDIASTREAMER2_INTERNAL_EXPORT void Castor3snd_reinit_for_diff_rate(int rate, int bitsize, int channel);
