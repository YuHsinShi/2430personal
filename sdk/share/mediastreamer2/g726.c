...
static void enc_init(MSFilter *f){
	...
	s->ptime=20;
	s->nsamples=(CFG_AUDIO_SAMPLING_RATE*s->ptime)/1000;
...
// #define MAKE_G726_DESC(32)
MSFilterDesc ms_g726_32_enc_desc={ \
	.id=MS_G726_32_ENC_ID, \
	.name="MSG726-32 Enc", \
	.text=N_("G726 encoder at 32 kbit/s"), \
...
MSFilterDesc ms_aal2_g726_32_enc_desc={ \
	.id=MS_AAL2_G726_32_ENC_ID, \
	.name="MSAAL2-G726-32 Enc", \
	.text=N_("AAL2-G726 encoder at 32 kbit/s"), \
	.category=MS_FILTER_ENCODER, \
	.enc_fmt="AAL2-G726-32", \
	.ninputs=1, \
	.noutputs=1, \
	.init=enc_init, \
	.preprocess=enc_preprocess, \
...
MSFilterDesc ms_g726_32_dec_desc={ \
	.id=MS_G726_32_DEC_ID, \
	.name="MSG726-32 Dec", \
	.text=N_("G726 decoder at 32 kbit/s"), \
...
MSFilterDesc ms_aal2_g726_32_dec_desc={ \
	.id=MS_AAL2_G726_32_DEC_ID, \
	.name="MSAAL2-G726-32 Dec", \
	.text=N_("AAL2-G726 decoder at 32 kbit/s"), \
	.category=MS_FILTER_DECODER, \
	.enc_fmt="AAL2-G726-32", \
	.ninputs=1, \
	.noutputs=1, \
...
// #define MAKE_G726_DESC(32)
MSFilterDesc ms_g726_32_desc={ \
	MS_G726_32_ENC_ID, \
	"MSG726-32 Enc", \
	N_("G726 encoder at 32 kbit/s"), \
	MS_FILTER_ENCODER, \
	"G726-32", \
	1, \
	1, \
...
MSFilterDesc ms_aal2_g726_32_desc={ \
	MS_AAL2_G726_32_ENC_ID, \
	"MSAAL2-G726-32 Enc", \
	N_("AAL2-G726 encoder at 32 kbit/s"), \
	MS_FILTER_ENCODER, \
	"AAL2-G726-32", \
	1, \
	1, \
...
MSFilterDesc ms_aal2_g726_32_dec_desc={ \
	...
	"MSAAL2-G726-32 Dec", \
	N_("AAL2-G726 decoder at 32 kbit/s"), \
	MS_FILTER_DECODER, \
	"AAL2-G726-32", \
	1, \
	1, \
