...
// instead of using void* which would be type unsafe
	...
	void MatrixXcf_Inverse(struct C_MatrixXcf *m1, struct C_MatrixXcf *m2, struct C_MatrixXcf *result);
	void MatrixXcf_KSICA(struct C_MatrixXcf *m1, struct C_MatrixXcf *m2, struct C_MatrixXcf *m3,
						 struct C_MatrixXcf *m4, struct C_MatrixXcf *m5, float *rY, struct C_MatrixXcf *m6,
						 struct C_MatrixXcf *result, int band);
