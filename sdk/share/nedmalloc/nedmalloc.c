...
#if 1 /* Effectively makes nedmalloc = dlmalloc */
#define THREADCACHEMAX 0
#define DEFAULT_GRANULARITY 0 //65536
...
extern
 #endif
 #if defined(__linux__) || defined(__FreeBSD__) || defined(__OPENRTOS__)
...
size_t (*sysblksize)(void *)=
	...
	_msize;
#elif defined(__linux__) || defined(__FreeBSD__) || defined(__OPENRTOS__)
