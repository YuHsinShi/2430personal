...
static void _initTouchIntr(void)
{
    ...
    ithGpioClearIntr(TP_GPIO_PIN);
    ithGpioRegisterIntrHandler(TP_GPIO_PIN, (ITHGpioIntrHandler)_tp_isr, NULL);
...
TSAPI struct tslib_module_info *zt2083_inv_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(zt2083_inv_mod_init);
#endif
