...
struct _LinphoneCallParams{
    ...
    bool_t call_only_ring;  /*call one with video and the others no video only ring*/
    bool_t video_from_ipcam;
    bool_t play_video_msg;
    bool_t refer_received;
    bool_t audio_recive_graph;
    bool_t camera_watch;
};
...
struct _LinphoneCore
{
    ...
    bool_t call_have_accepted;
    struct _VideoStream *cam_pb_stream;
};
