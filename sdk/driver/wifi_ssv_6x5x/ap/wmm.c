...
ssv_type_u8* hostapd_eid_wmm(ApInfo_st *pApInfo, ssv_type_u8 *eid)
{
	ssv_type_u8 *pos = eid;
...
//		return eid;
	...
	OS_MemCPY((void*)wmm->ac, (void*)&ac_params, sizeof(wmm->ac));
 ...
 */
int hostapd_eid_wmm_valid(ApInfo_st *pApInfo, const ssv_type_u8 *eid, ssv_type_size_t len)
{
