...
#define JPG_MSK_INTERRUPT_BITSTREAM_BUF_FULL       (0x4000)
#define JPG_MSK_INTERRUPT_ENCODE_END               (0x0200)
#define JPG_MSK_INTERRUPT_DECODE_END               (0x0100)
...
#define JPG_MSK_INTERRUPT_CLEAR                    (0x8000)
