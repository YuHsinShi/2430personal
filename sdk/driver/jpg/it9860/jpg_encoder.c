    ...
    bool                *bEncIdle)
{
    ...
    do{
        ...
        *bEncIdle = false;
        ...
        // complete or bs_full
        //printf("before bsBufValidSize !!\n");
		//while(1);
        bsBufValidSize = JPG_GetBitStreamValidSizeReg();
		printf("bsBufValidSize=0x%x\n",bsBufValidSize);
		bsBufValidSize *= 4;
		//bsBufValidSize += 15000;
    ...
    do{
       ...
       pJEncoder->jBsRingBufInfo.rwSize = 0;
        ...
        while( remainSliceNum > 0 )
        {
            ...
            printf("(procSliceNum/pJFrmComp->jFrmInfo[0].verticalSamp)=0x%x,pJFrmComp->jFrmInfo[0].verticalSamp=0x%x,procSliceNum=0x%x\n",(procSliceNum/pJFrmComp->jFrmInfo[0].verticalSamp),pJFrmComp->jFrmInfo[0].verticalSamp,procSliceNum);
