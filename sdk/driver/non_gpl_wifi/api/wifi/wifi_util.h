...
int wext_get_drv_ability(const char *ifname, unsigned int *ability);
...
int wext_set_lps_thresh(const char *ifname, unsigned char low_thresh); //eason 0712
int wext_set_beacon_mode(const char *ifname, unsigned char mode); //eason 0712
