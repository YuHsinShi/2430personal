...
unsigned long
RT_wait_for_completion_timeout_ite(
   struct completion_ite *x, 
...
printf("tasklet_doprocess \n");
	...
	while(gTaskRunning)
	{
		 ...
		 if(tasklethiCount)
		 {
           ...
           //printf("--\n"); 
                    if (NULL == tasklethi[tasklethiR].func){
                        printf("tasklethi[tasklethiR].func NULL \n");
                        usleep(20000);
                    } else {          
	     ...
	     else if(taskletCount)
		 {
            ...
            //printf("**\n");  
                if (NULL == tasklet[taskletR].func){
                    printf("tasklet[taskletR].func NULL \n");
                    usleep(20000);
                } else {                     
            ...
            if(taskletCount > 5)
            {
				do
				{
		            ...
		            //printf("**\n");  
                                if (NULL == tasklet[taskletR].func){
                                    printf("tasklet[taskletR].func > 5  NULL \n");
                                    usleep(20000);
                                } else {                     
					(tasklet[taskletR].func)(tasklet[taskletR].data);
                                }
