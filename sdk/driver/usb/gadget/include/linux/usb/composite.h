...
#if DEV_DBG
#define dev_dbg(ddev, string, args...)    do { ithPrintf("[usbd][DBG] "); ithPrintf(string, ## args); } while (0)
#define dev_vdbg(ddev, string, args...)    do { ithPrintf("[usbd][DBG] "); ithPrintf(string, ## args); } while (0)
#else
...
#if DEV_ERR
#define dev_err(ddev, string, args...)    do { ithPrintf("[usbd][ERR] "); ithPrintf(string, ## args); } while (0)
#else
#define dev_err(ddev, string, args...)
#endif

#if DEV_WARN
#define dev_warn(ddev, string, args...)    do { ithPrintf("[usbd][WARN] "); ithPrintf(string, ## args); } while (0)
#define WARN(n, string, args...)           do { ithPrintf("[usbd][WARN] "); ithPrintf(string, ## args); } while (0)
#else
...
#if DEV_INFO
#define dev_info(ddev, string, args...)    do { ithPrintf("[usbd][INFO] "); ithPrintf(string, ## args); } while (0)
#else
