...
//=============================================================================
    ...
    // Host
    #define isp_ReadHwReg(add, data)            (*data = ithReadRegA(add))
    #define isp_WriteHwReg(add, data)           ithWriteRegA(add, data)
    #define isp_WriteHwRegMask(add, data, mark) ithWriteRegMaskA(add, data, mark)
    ...
    #define isp_EnginReset(ispcore)             ithIspResetEngine(ispcore)
