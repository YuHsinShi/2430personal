...
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data)     mdioWrite(phyID, regID, data)
#define MDC_MDIO_READ(preamableLength, phyID, regID, pData)     mdioRead(phyID, regID, pData)

static void mdioRead(rtk_uint32 phyad, rtk_uint32 regad, rtk_uint32 *data)
{
...
static void mdioWrite(rtk_uint32 phyad, rtk_uint32 regad, rtk_uint32 data)
{
