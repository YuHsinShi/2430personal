 ...
 * @param pin the GPIO pin to set to input mode.
 */
#define ITH_GPIO_SET_IN(pin)  \
    do { \
        if((pin) <= 31) \
           ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO1_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 32 && (pin) <= 63 ) \
           ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO2_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 64 && (pin) <= 95 ) \
           ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO3_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 96 && (pin) <= 127 ) \
           ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO4_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
    } while(0)
 ...
 * @param pin the GPIO pin to set to output mode.
 */
#define ITH_GPIO_SET_OUT(pin) \
    do { \
        if((pin) <= 31) \
           ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO1_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 32 && (pin) <= 63 ) \
           ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO2_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 64 && (pin) <= 95 ) \
           ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO3_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 96 && (pin) <= 127 ) \
           ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO4_PINDIR_REG) & (0x1 << (pin & 0x1F)); \
    } while(0)  
 ...
 * @param pin the GPIO pin to set to 1.
 */
#define ITH_GPIO_SET(pin) \
    do { \
        if((pin) <= 31) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO1_DATASET_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 32 && (pin) <= 63 ) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO2_DATASET_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 64 && (pin) <= 95 ) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO3_DATASET_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 96 && (pin) <= 127 ) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO4_DATASET_REG) & (0x1 << (pin & 0x1F)); \
    } while(0)    
 ...
 * @param pin the GPIO pin to set to 0.
 */
#define ITH_GPIO_CLEAR(pin) \
    do { \
        if((pin) <= 31) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO1_DATACLR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 32 && (pin) <= 63 ) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO2_DATACLR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 64 && (pin) <= 95 ) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO3_DATACLR_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 96 && (pin) <= 127 ) \
           ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO4_DATACLR_REG) & (0x1 << (pin & 0x1F)); \
    } while(0)
 ...
 * @param pin the GPIO pin to get.
 */
#define ITH_GPIO_GET(RESULT, pin) \
    do { \
        if((pin) <= 31) \
           RESULT = ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO1_DATAIN_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 32 && (pin) <= 63 ) \
           RESULT = ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO2_DATAIN_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 64 && (pin) <= 95 ) \
           RESULT = ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO3_DATAIN_REG) & (0x1 << (pin & 0x1F)); \
        else if( (pin) >= 96 && (pin) <= 127 ) \
           RESULT = ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO4_DATAIN_REG) & (0x1 << (pin & 0x1F)); \
    } while(0)
