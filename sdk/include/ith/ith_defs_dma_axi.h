...
#else
#define ITH_DMA_HW_SRC_SEL_MSK(ch)        (0x3F << ((ch % 4)*8))
#endif
...
typedef enum
{
    ...
    ITH_DMA_IIC3_TX      = 6,
    ITH_DMA_IIC3_RX      = 7,
    ITH_DMA_IR_CAP0_RX   = 8,
    ITH_DMA_IR_CAP0_TX   = 9,
    ...
    ITH_DMA_IR_CAP2_RX   = 30,
    ITH_DMA_IR_CAP2_TX   = 31,
    ITH_DMA_IR_CAP3_RX   = 32,
    ITH_DMA_IR_CAP3_TX   = 33
} ITHDmaRequest;
