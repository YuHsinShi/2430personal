...
/**
 * To update conference member count.
**/
MS2_PUBLIC void ms_audio_conference_update_member_count(bool_t add);

MS2_PUBLIC bool_t ms_audio_conference_check_member_ready(MSAudioConference *obj);
