...
#define PAGE_PROGRAM_4PP_CMD   0x38 //3byte addr, 4bit write.
#define PAGE_PROGRAM_4PP4B_CMD 0x3E //4byte addr, 4bit write.
#define QuadREAD_CMD           0xEB //3byte addr, 4bit read.
#define READ4B4B_CMD           0xEC //4byte addr, 4bit read.
#define QuadREAD_DTR_CMD       0xED //3byte addr, 4bit read, DTR mode.
#define READ4B4B_DTR_CMD       0xEE //4byte addr, 4bit read, DTR mode.

#define READ_STATUS_CMD     0x05
#define READ_STATUS_2_CMD   0x35
#define WRITE_STATUS_CMD    0x01
#define WRITE_STATUS_2_CMD  0x31
