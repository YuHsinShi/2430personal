...
/**
* This routine is used to erase sectors.
*
* @param sector		 the start sector to be erased.
* @param count		 sector count.

* @return zero if succeed, otherwise return non-zero error codes.
*/
int iteSdEraseEx(int index, uint32_t sector, int count);
...
#define SDIO_ESP32_WROOM_32_AT  0x02
