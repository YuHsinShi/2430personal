...
extern "C" {
    ...
    #define DECLARE_COULD_BE_MOCKED_FUNC1_EX(ret_type, func, para1_type)                    \
        extern ret_type func( ## para1_type);                                               \
        extern ret_type ## (*_ ## func)( ## para1_type);                                    \
        extern ret_type func ## _default( ## para1_type)
    ...
    #define DECLARE_COULD_BE_MOCKED_FUNC2_EX(ret_type, func, para1_type, para2_type)        \
        extern ret_type func( ## para1_type, ## para2_type);                                \
        extern ret_type ## (*_ ## func)( ## para1_type, ## para2_type);                     \
        extern ret_type func ## _default( ## para1_type, ## para2_type)
    #define DECLARE_COULD_BE_MOCKED_FUNC3(ret_type, func, para1_type, para2_type, para3_type)       \
        extern ret_type ## (*_ ## func)( ## para1_type, ## para2_type, ## para3_type);              \
        extern ret_type func ## _default( ## para1_type, ## para2_type, ## para3_type)
    #define DECLARE_COULD_BE_MOCKED_FUNC3_EX(ret_type, func, para1_type, para2_type, para3_type)    \
        extern ret_type func( ## para1_type, ## para2_type, ## para3_type);                         \
        extern ret_type ## (*_ ## func)( ## para1_type, ## para2_type, ## para3_type);              \
        extern ret_type func ## _default( ## para1_type, ## para2_type, ## para3_type)
...
#define DEFINE_COULD_BE_MOCKED_VOID_FUNC3(func, para1_type, para1_name, para2_type, para2_name, para3_type, para3_name) \
        void ## (*_ ## func)(para1_type, para2_type, para3_type) = func ## _default;                            \
        void            func ## ( ## para1_type para1_name ## , ## para2_type para2_name ## , ## para3_type para3_name ## ) { if (_ ## func) { _ ## func( ## para1_name, ## para2_name, ## para3_name); } } \
        void            func ## _default( ## para1_type para1_name ## , ## para2_type para2_name ## , ## para3_type para3_name ## )
