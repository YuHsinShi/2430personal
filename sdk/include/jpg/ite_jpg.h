...
typedef enum JPG_EX_COLOR_SPACE_TAG
{
    JPG_COLOR_SPACE_NORMAL  = 0,
    JPG_COLOR_SPACE_NV12,
    JPG_COLOR_SPACE_NV21,
} JPG_EX_COLOR_SPACE;
...
/**
 * Alpha Plane Base Setting
 */
typedef struct JPG_ALPHA_PLANE_TAG
{
    uint8_t     *AlphaPlaneAddr;
    uint16_t    AlphaPlanePitch;
	bool		bEnConstAlpha;
	uint16_t	ConstAlpha;
...
typedef struct JPG_INIT_PARAM_TAG
{
    ...
    // base info
    JPG_COLOR_SPACE     outColorSpace;
    JPG_EX_COLOR_SPACE  exColorSpace;
    ...
    JPG_ALPHA_PLANE     alphaPlane; // for decode jpg to ARGB4444 or ARGB8888
