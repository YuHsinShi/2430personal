...
#if 0 //defined(WIN32) && !defined(_WIN32_WCE) && !defined(__CYGWIN__)
...
#if 1 //!defined(WIN32) && !defined(_WIN32_WCE)
#include <sys/socket.h>
#endif

#if 1 //!defined(WIN32) && !defined(__WATCOMC__) && !defined(__VXWORKS__)
#include <sys/time.h>
#endif
...
/* socket typedef */
#if 0 //defined(WIN32) && !defined(__LWIP_OPT_H__) && !defined(LWIP_HDR_OPT_H)
