...
static void SWFlip(ITUSurface *surf)
{
    ...
    if (ituEmuWin)
    {
        ...
        StretchBlt(dc, 0, 0, ithLcdGetWidth() * ituEmuScale / 100, ithLcdGetHeight() * ituEmuScale / 100, bitmapDc, 0, 0, ithLcdGetWidth(), ithLcdGetHeight(), SRCCOPY);

        DeleteDC(bitmapDc);
        ReleaseDC(ituEmuWin, dc);
