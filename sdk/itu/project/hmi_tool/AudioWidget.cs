...
namespace GUIDesigner
{
    class AudioWidget : FontDialog, IWidget
    {
        ...
        [LocalizedDescription("Name", typeof(WidgetManual))]
        public string Name
        {
            get
            {
        ...
        [LocalizedDescription("AudioFilePath", typeof(WidgetManual))]
        public string FilePath { get; set; }
        [LocalizedDescription("VolumeEnable", typeof(WidgetManual))]
        public bool VolumeEnable { get; set; }
        [LocalizedDescription("Volume", typeof(WidgetManual))]
