...
namespace GUIDesigner
{
    class TrackBarWidget : Panel, IWidget
    {
        ...
        [LocalizedDescription("Jumpable", typeof(WidgetManual))]
        ...
        [LocalizedDescription("TrackBarGap", typeof(WidgetManual))]
        ...
        [LocalizedDescription("TrackerTarget", typeof(WidgetManual))]
        ...
        [LocalizedDescription("TipTarget", typeof(WidgetManual))]
        [TypeConverter(typeof(StringListConverter))]
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            {
                tbar.staticSurf = ITU.CreateSurfaceNode(this.BackgroundImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }
            if (this.External)
