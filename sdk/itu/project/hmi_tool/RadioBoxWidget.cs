...
namespace GUIDesigner
{
    class RadioBoxWidget : RadioButton, IWidget
    {
        ...
        public override Image BackgroundImage
        {
            ...
            set
            {
                if (previewImage == RadioBoxImageType.Default && this.DefaultImage == null)
        ...
        public Image FocusImage
        {
            ...
            set
            {
                ...
                if (previewImage == RadioBoxImageType.Focus)
        ...
        public Image CheckedImage
        {
            ...
            set
            {
                ...
                if (previewImage == RadioBoxImageType.Checked)
                    base.BackgroundImage = value;
            }
        }
        ...
        public Image FocusCheckedImage
        {
            ...
            set
            {
                ...
                if (previewImage == RadioBoxImageType.FocusChecked)
                    base.BackgroundImage = value;
            }
        }
        ...
        public Image DefaultImage
        {
            ...
            set
            {
                ...
                if (previewImage == RadioBoxImageType.Default)
                    base.BackgroundImage = value;
            }
        }

        public enum RadioBoxImageType
        {
            Default,
            Focus,
            Checked,
        ...
        private RadioBoxImageType previewImage = RadioBoxImageType.Default;
        public RadioBoxImageType PreviewImage
        {
            ...
            set
            {
                switch (value)
                {
                    case RadioBoxImageType.Focus:
                        base.BackgroundImage = this.FocusImage;
                        break;

                    case RadioBoxImageType.Checked:
                        base.BackgroundImage = this.CheckedImage;
                        break;

                    case RadioBoxImageType.FocusChecked:
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            {
                radiobox.staticSurf = ITU.CreateSurfaceNode(this.DefaultImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }
            if (this.External)
            ...
            if (this.Stretch)
                radiobox.flags |= ITU.ITU_STRETCH;

            if (this.FocusImage != null)
            {
                radiobox.staticFocusSurf = ITU.CreateSurfaceNode(this.FocusImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }

            if (this.PressImage != null)
            {
                radiobox.staticPressSurf = ITU.CreateSurfaceNode(this.PressImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }
            ...
            {
                radiobox.staticCheckedSurf = ITU.CreateSurfaceNode(this.CheckedImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }            
            radiobox._checked = this.Checked ? 1 : 0;

            if (this.FocusCheckedImage != null)
            {
                radiobox.staticFocusCheckedSurf = ITU.CreateSurfaceNode(this.FocusCheckedImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }
