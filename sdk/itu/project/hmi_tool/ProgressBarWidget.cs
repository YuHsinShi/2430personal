...
namespace GUIDesigner
{
    class ProgressBarWidget : Button, IWidget
    {
        ...
        [LocalizedDescription("Minimum", typeof(WidgetManual))]
        public int Minimum { get; set; }
        [LocalizedDescription("Maximum", typeof(WidgetManual))]
        public int Maximum { get; set; }
        [LocalizedDescription("Step", typeof(WidgetManual))]
        ...
        [LocalizedDescription("BarImage", typeof(WidgetManual))]
        [Editor(typeof(ImageLocationEditor), typeof(UITypeEditor))]
        ...
        [LocalizedDescription("ValueTarget", typeof(WidgetManual))]
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            {
                bar.staticSurf = ITU.CreateSurfaceNode(this.BackgroundImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }
            if (this.External)
            ...
            {
                bar.staticBarSurf = ITU.CreateSurfaceNode(this.BarImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }            
        ...
        public void SaveImages(String path)
        {
            ...
            if (this.BarImage != null)
            {
                ...
                ITU.SaveImage(bitmap, path, LayerWidget.FindLayerName(this), this.Name + "_BarImage");
            }
        }
