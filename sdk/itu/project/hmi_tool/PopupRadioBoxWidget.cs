...
{
    class PopupRadioBoxWidget : RadioButton, IWidget
    {
        public PopupRadioBoxWidget()
        {
            ...
            this.Compress = true;
            this.TotalFrame = 10;
            this.IncreasePercent = 30;
            this.AlphaPercent = 50;
            this.BoldSize = 1;
            this.Dither = true;
        ...
        [LocalizedDescription("IncreasePercent", typeof(WidgetManual))]
        public int IncreasePercent { get; set; }
        [LocalizedDescription("AlphaPercent", typeof(WidgetManual))]
        ...
        {
            ITUPopupRadioBox prb = new ITUPopupRadioBox();

            prb.name = this.Name;
            prb.flags |= this.TabStop ? ITU.ITU_TAPSTOP : 0;
            prb.flags |= this.ResponseToUpKey ? ITU.ITU_RESPONSE_TO_UP_KEY : 0;

            PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(this);
            prb.visible = (bool)properties["Visible"].GetValue(this);

            prb.active = false;
            prb.dirty = false;
            prb.alpha = this.Alpha;
            prb.tabIndex = this.TabIndex;
            prb.rect.x = this.Location.X;
            prb.rect.y = this.Location.Y;
            prb.rect.width = this.Size.Width;
            prb.rect.height = this.Size.Height;
            prb.color.alpha = this.BackColor.A;
            prb.color.red = this.BackColor.R;
            prb.color.green = this.BackColor.G;
            prb.color.blue = this.BackColor.B;
            prb.bound.x = 0;
            prb.bound.y = 0;
            prb.bound.width = 0;
            prb.bound.height = 0;
            ...
            {
                prb.staticSurf = ITU.CreateSurfaceNode(this.BackgroundImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }

            ITUBorderWindow bwin = prb.bwin.widget as ITUBorderWindow;
            bwin.name = "";
            bwin.visible = true;
            bwin.active = false;
            bwin.dirty = false;
            ...
            ITUText text = prb.text.widget as ITUText;
            text.name = "";
            text.visible = true;
            text.active = false;
            text.dirty = false;
            ...
            prb.bgColor.alpha = this.BackColor.A;
            prb.bgColor.red = this.BackColor.R;
            prb.bgColor.green = this.BackColor.G;
            prb.bgColor.blue = this.BackColor.B;
            prb.focusColor.alpha = this.FlatAppearance.MouseOverBackColor.A;
            prb.focusColor.red = this.FlatAppearance.MouseOverBackColor.R;
            prb.focusColor.green = this.FlatAppearance.MouseOverBackColor.G;
            prb.focusColor.blue = this.FlatAppearance.MouseOverBackColor.B;

            if (this.FocusImage != null)
            {
                prb.staticFocusSurf = ITU.CreateSurfaceNode(this.FocusImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }            
            prb.pressColor.alpha = this.FlatAppearance.MouseDownBackColor.A;
            prb.pressColor.red = this.FlatAppearance.MouseDownBackColor.R;
            prb.pressColor.green = this.FlatAppearance.MouseDownBackColor.G;
            prb.pressColor.blue = this.FlatAppearance.MouseDownBackColor.B;
            prb.pressed = 0;

            prb.checkedColor.alpha = this.FlatAppearance.CheckedBackColor.A;
            prb.checkedColor.red = this.FlatAppearance.CheckedBackColor.R;
            prb.checkedColor.green = this.FlatAppearance.CheckedBackColor.G;
            prb.checkedColor.blue = this.FlatAppearance.CheckedBackColor.B;

            prb.checkedFontColor.alpha = this.CheckedFontColor.A;
            prb.checkedFontColor.red = this.CheckedFontColor.R;
            prb.checkedFontColor.green = this.CheckedFontColor.G;
            prb.checkedFontColor.blue = this.CheckedFontColor.B;
            prb.orgFontColor.alpha = this.ForeColor.A;
            prb.orgFontColor.red = this.ForeColor.R;
            prb.orgFontColor.green = this.ForeColor.G;
            prb.orgFontColor.blue = this.ForeColor.B;

            if (this.CheckedImage != null)
            {
                prb.staticCheckedSurf = ITU.CreateSurfaceNode(this.CheckedImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }            
            prb._checked = this.Checked ? 1 : 0;

            if (this.FocusCheckedImage != null)
            {
                prb.staticFocusCheckedSurf = ITU.CreateSurfaceNode(this.FocusCheckedImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }

            prb.flags |= ITU.ITU_STRETCH;
            prb.totalframe = this.TotalFrame;
            prb.incPercent = this.IncreasePercent;
            prb.alphaPercent = this.AlphaPercent;

            prb.actions[0].action = (ITUActionType)this.Action01.Action;
            prb.actions[0].ev = (ITUEvent)this.Action01.Event;
            prb.actions[0].target = this.Action01.Target;
            prb.actions[0].param = this.Action01.Parameter;
            prb.actions[1].action = (ITUActionType)this.Action02.Action;
            prb.actions[1].ev = (ITUEvent)this.Action02.Event;
            prb.actions[1].target = this.Action02.Target;
            prb.actions[1].param = this.Action02.Parameter;
            prb.actions[2].action = (ITUActionType)this.Action03.Action;
            prb.actions[2].ev = (ITUEvent)this.Action03.Event;
            prb.actions[2].target = this.Action03.Target;
            prb.actions[2].param = this.Action03.Parameter;
            prb.actions[3].action = (ITUActionType)this.Action04.Action;
            prb.actions[3].ev = (ITUEvent)this.Action04.Event;
            prb.actions[3].target = this.Action04.Target;
            prb.actions[3].param = this.Action04.Parameter;
            prb.actions[4].action = (ITUActionType)this.Action05.Action;
            prb.actions[4].ev = (ITUEvent)this.Action05.Event;
            prb.actions[4].target = this.Action05.Target;
            prb.actions[4].param = this.Action05.Parameter;
            prb.actions[5].action = (ITUActionType)this.Action06.Action;
            prb.actions[5].ev = (ITUEvent)this.Action06.Event;
            prb.actions[5].target = this.Action06.Target;
            prb.actions[5].param = this.Action06.Parameter;
            prb.actions[6].action = (ITUActionType)this.Action07.Action;
            prb.actions[6].ev = (ITUEvent)this.Action07.Event;
            prb.actions[6].target = this.Action07.Target;
            prb.actions[6].param = this.Action07.Parameter;
            prb.actions[7].action = (ITUActionType)this.Action08.Action;
            prb.actions[7].ev = (ITUEvent)this.Action08.Event;
            prb.actions[7].target = this.Action08.Target;
            prb.actions[7].param = this.Action08.Parameter;
            prb.actions[8].action = (ITUActionType)this.Action09.Action;
            prb.actions[8].ev = (ITUEvent)this.Action09.Event;
            prb.actions[8].target = this.Action09.Target;
            prb.actions[8].param = this.Action09.Parameter;
            prb.actions[9].action = (ITUActionType)this.Action10.Action;
            prb.actions[9].ev = (ITUEvent)this.Action10.Event;
            prb.actions[9].target = this.Action10.Target;
            prb.actions[9].param = this.Action10.Parameter;
            prb.actions[10].action = (ITUActionType)this.Action11.Action;
            prb.actions[10].ev = (ITUEvent)this.Action11.Event;
            prb.actions[10].target = this.Action11.Target;
            prb.actions[10].param = this.Action11.Parameter;
            prb.actions[11].action = (ITUActionType)this.Action12.Action;
            prb.actions[11].ev = (ITUEvent)this.Action12.Event;
            prb.actions[11].target = this.Action12.Target;
            prb.actions[11].param = this.Action12.Parameter;
            prb.actions[12].action = (ITUActionType)this.Action13.Action;
            prb.actions[12].ev = (ITUEvent)this.Action13.Event;
            prb.actions[12].target = this.Action13.Target;
            prb.actions[12].param = this.Action13.Parameter;
            prb.actions[13].action = (ITUActionType)this.Action14.Action;
            prb.actions[13].ev = (ITUEvent)this.Action14.Event;
            prb.actions[13].target = this.Action14.Target;
            prb.actions[13].param = this.Action14.Parameter;
            prb.actions[14].action = (ITUActionType)this.Action15.Action;
            prb.actions[14].ev = (ITUEvent)this.Action15.Event;
            prb.actions[14].target = this.Action15.Target;
            prb.actions[14].param = this.Action15.Parameter;
