...
{
    class ScaleCoverFlowWidget : Panel, IWidget
    {
        public ScaleCoverFlowWidget()
        {
        ...
        private int factor;
        [LocalizedDescription("Factor", typeof(WidgetManual))]
        public int Factor
        {
            get
            {
        ...
        {
            ITUScaleCoverFlow coverFlow = new ITUScaleCoverFlow();

            coverFlow.type = ITUWidgetType.ITU_SCALECOVERFLOW;
            ...
            coverFlow.bounceRatio = 10;
            coverFlow.boundaryAlign = 0;
            coverFlow.slideCount = 0;
            coverFlow.slideMaxCount = 2;
            coverFlow.overlapsize = this.Overlapsize;
            coverFlow.concentration = this.Concentration;
            ...
            if (this.Draggable)
            {
                coverFlow.draggable = 1;
            }
            else
            {
                coverFlow.draggable = 0;
            }
            ...
            coverFlow.factor = this.Factor;
            coverFlow.itemCount = this.ItemCount;
