...
namespace GUIDesigner
{
    class CoverFlowWidget : Panel, IWidget
    {
        ...
        [LocalizedDescription("BounceRatio", typeof(WidgetManual))]
        ...
        private int min_tf = 2;
        [LocalizedDescription("MinChangeFactor", typeof(WidgetManual))]
        public int MinChangeFactor
        {
            get { return min_tf; }
            set
            {
        ...
        private int eye_mt = 0;
        [LocalizedDescription("EyeMotion", typeof(WidgetManual))]
        public int EyeMotion
        {
            get { return eye_mt; }
            set
            {
        ...
        //[LocalizedDescription("StopAnywhere", typeof(WidgetManual))]
        ...
        [LocalizedDescription("Overlapsize", typeof(WidgetManual))]
        ...
        [LocalizedDescription("SlideMaxCount", typeof(WidgetManual))]
        public int SlideMaxCount { get; set; }

        private int spv = 0;
        [LocalizedDescription("Split", typeof(WidgetManual))]
        public int Split
        {
            get { return spv; }
            set
            {
                ...
                else if ((value > (this.Size.Height / 4)) && (this.Orientation == CoverFlowWidgetLayout.Vertical))
                {
                    spv = this.Size.Height / 4;
                }
                else if ((value > (this.Size.Width / 4)) && (this.Orientation != CoverFlowWidgetLayout.Vertical))
                {
                    spv = this.Size.Width / 4;
                }
                else
                {
                    spv = value;
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            coverFlow.split = this.Split;
            coverFlow.slide_diff = 0;
            coverFlow.mousedown_position = 0;
            coverFlow.min_change_dist_factor = this.MinChangeFactor;
            coverFlow.init_drag_xy = 0;
            coverFlow.boundary_touch_memo = 0;
            coverFlow.org_totalframe = this.TotalFrame;
            coverFlow.eye_motion = this.EyeMotion;
            coverFlow.boundary_memo1 = 0;
            coverFlow.boundary_memo2 = 0;
            ...
            if (this.Orientation == CoverFlowWidgetLayout.Vertical)
            {
                ...
                if (this.Split > (this.Size.Height / 4))
                {
                    this.Split = this.Size.Height / 4;
                    spv = this.Size.Height / 4;
                    coverFlow.split = this.Split;
                }
            }
            ...
            {
                if (this.Split > (this.Size.Width / 4))
                {
                    this.Split = this.Size.Width / 4;
                    spv = this.Size.Width / 4;
                    coverFlow.split = this.Split;
                }
            }
