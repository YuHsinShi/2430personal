...
{
    class TableListBoxWidget : ListBox, IWidget
    {
        public TableListBoxWidget()
        {
            ...
            this.FontChanged += new EventHandler(TableListBoxWidget_FontChanged);
        }

        void TableListBoxWidget_FontChanged(object sender, EventArgs e)
        {
