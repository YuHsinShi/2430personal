...
{
    class CircleProgressBarWidget : Panel, IWidget
    {
        public CircleProgressBarWidget()
        {
        ...
        [LocalizedDescription("ProgressTarget", typeof(WidgetManual))]
        [TypeConverter(typeof(StringListConverter))]
        public String ProgressTarget { get; set; }

        [LocalizedDescription("PercentTarget", typeof(WidgetManual))]
        [TypeConverter(typeof(StringListConverter))]
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            bar.cacheCount = this.CacheCount;
