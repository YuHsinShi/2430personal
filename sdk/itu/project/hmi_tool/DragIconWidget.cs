...
namespace GUIDesigner
{
    class DragIconWidget : PictureBox, IWidget
    {
        ...
        [LocalizedDescription("ImagePixelFormat", typeof(WidgetManual))]
        public ITU.WidgetPixelFormat ImagePixelFormat { get; set; }
        [LocalizedDescription("BackImagePixelFormat", typeof(WidgetManual))]
        ...
        [LocalizedDescription("ActiveAniFrame", typeof(WidgetManual))]
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            {
                widget.staticBackSurf = ITU.CreateSurfaceNode(this.BackgroundImage as Bitmap, this.BackImagePixelFormat, false, false, false);
            }

            if (this.Image != null)
            {
                widget.staticIconSurf = ITU.CreateSurfaceNode(this.Image as Bitmap, this.ImagePixelFormat, false, false, false);
            }
