...
{
    class PopupButtonWidget : Button, IWidget
    {
        ...
        [LocalizedDescription("TextScaleFactor", typeof(WidgetManual))]
        public int TextScaleFactor { get; set; }
        ...
        public ITUWidget CreateITUWidget()
        {
            ...
            {
                btn.staticSurf = ITU.CreateSurfaceNode(this.BackgroundImage as Bitmap, this.PixelFormat, this.Compress, this.External, this.Dither);
            }
            if (this.External)
            ...
            btn.orgFontSize = 0;
            btn.textScaleFactor = this.TextScaleFactor;
