...
{
    class RippleBackgroundWidget : Panel, IWidget
    {
        public RippleBackgroundWidget()
        {
        ...
        [LocalizedDescription("Radius", typeof(WidgetManual))]
        public int Radius { get; set; }
        [LocalizedDescription("Range", typeof(WidgetManual))]
