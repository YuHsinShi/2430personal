...
{
    class ListBoxWidget : ListBox, IWidget
    {
        public ListBoxWidget()
        {
            ...
            this.FontChanged += new EventHandler(ListBoxWidget_FontChanged);
        }

        void ListBoxWidget_FontChanged(object sender, EventArgs e)
        {
