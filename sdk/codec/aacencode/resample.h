...
#define LOOKUP_TABLE
#define RESAMPLE_FILTER_LENGTH  8
...
#define TEMP_BUFFER_SIZE 10000  // MAX_FRAMESIZE*8 

typedef struct AVResampleContext{
    //const AVClass *av_class;
#ifdef LOOKUP_TABLE
    //    signed __int16 *filter_bank; //MAX(22,16) * (1024+1)
    short *filter_bank; //MAX(22,16) * (1024+1)
#else
    signed __int16 filter_bank[11275*2]; //MAX(22,16) * (1024+1) //11,8
#endif
...
typedef struct ResampleAudioContext{
    ...
    short reSamplePcmOutput[2][MAX_FRAMESIZE*2];
