...
#include "config.h"
      ...
      static Word32* gMdctSpectrum;
    #else
      static Word32 gMdctSpectrum[MAX_CHANNELS*FRAME_LEN_LONG];
    #endif
  static Word32 gScratchTNS[MAX_CHANNELS*FRAME_LEN_LONG];
  static Word16 gMdctDelayBuffer[MAX_CHANNELS*BLOCK_SWITCHING_OFFSET];
#endif
...
#ifdef STATIC_MEMORY
    #ifdef AAC_ENABLE_INTERNAL_SD
        gMdctSpectrum = (Word32*)INTERNAL_SD;
    #endif
  mdctSpectrum = gMdctSpectrum;    
#else
...
#ifdef STATIC_MEMORY
  mdctDelayBuffer = gMdctDelayBuffer;
#else
