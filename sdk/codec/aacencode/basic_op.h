...
#define L_negate(L_var1) (((L_var1) == (MIN_32)) ? (MAX_32) : (-(L_var1)))
...
#if defined(__OR32__)
 __inline int MULHIGH(Word32 a, Word32 b) {
    int result;
 ...
 __inline int MUL(Word32 a, Word32 b) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
    asm volatile("l.macrc %0, 0" : "=r"(result) );
    return result;
}

 __inline int MULADD32(Word32 a, Word32 b, Word32 c, Word32 d) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
 ...
 __inline int MULSUB32(Word32 a, Word32 b, Word32 c, Word32 d) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
 ...
 __inline int MUL_2(Word32 a, Word32 b) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
 ...
 __inline int MUL_7(Word32 a, Word32 b) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
    asm volatile("l.macrc %0, 7" : "=r"(result) );
    return result;
}

 __inline int MUL_18(Word32 a, Word32 b) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
 ...
 __inline int MUL_33(Word32 a, Word32 b) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
    asm volatile("l.macrc %0, 33" : "=r"(result) );
    return result;
}

 __inline int fixmul(Word32 a, Word32 b) {
    int result;
    asm volatile("l.mac %0, %1" : : "%r"(a), "r"(b));
    asm volatile("l.macrc %0, 31" : "=r"(result) );
    return result;
}
...
/*#elif defined(__OR32__)
    ...
    if(var2>=0) 
	{
		asm volatile("l.slls %0, %1, %2" : "=r"(result) : "%r"(L_var1), "r"(var2));
    }
	else
	{
...
/*#elif defined(__OR32__)
	...
	if(var2>=0) 
	{
		asm volatile("l.sra %0, %1, %2" : "=r"(result) : "%r"(L_var1), "r"(var2));
	}
	else
	{
...
__inline Word32 norm_s (Word32 var1)
{
  ...
  if ( var1 < 0 )
        var1 = ~var1;
  asm volatile("l.fl1 %0, %1" : "=r"(result) : "r"(var1));
  return (Word16)(15-result);
#else
    Word32 var_out;
...
__inline Word32 norm_l (Word32 L_var1)
{
  ...
  if ( L_var1 < 0 )
    L_var1 = ~L_var1;
  asm volatile("l.fl1 %0, %1" : "=r"(result) : "r"(L_var1));
  return (Word16)(31-result);
#else
    //Word16 var_out;
...
__inline Word32 mult_r (Word32 var1, Word32 var2)
{
    ...
    #if defined(__OR32__)      
      asm volatile("l.mac %0, %1" : : "%r"(var1), "r"(var2));
      asm volatile("l.mac %0, %1" : : "%r"(1), "r"(0x00004000L));    
      asm volatile("l.macrc %0, 15" : "=r"(L_product_arr) );
    #else    
...
__inline Word32 Div(Word32 L_num, Word32 L_denom)
{
    Word32 result;
#if defined(__OR32__)
	asm volatile("l.div %0, %1, %2" : "=r"(result) : "%r"(L_num), "r"(L_denom));
#else
	result = L_num / L_denom;				
#endif
