   ...
   *-----------------------------------------------------------------------*/
    ...
    while (1) {
        ...
        if ((inwrptr - inrdptr) >= 323 || (inwrptr - inrdptr) < 0) {
            ...
            #if 0
            MMIO_Write(DrvEncode_Frame_Lo, (short)( ((unsigned int)(nFrames*((20<<16)/1000))) & 0xffff));
            MMIO_Write(DrvEncode_Frame_Hi, (short)( ((unsigned int)(nFrames*((20<<16)/1000))) >> 16)   );
            #else
            ...
            MMIO_Write(DrvDecode_Frame_Lo  , (short)( ((unsigned int)encTime) & 0xffff));
            MMIO_Write(DrvDecode_Frame_Hi, (short)( ((unsigned int)encTime) >> 16)   );
            #endif
        }
    }
