...
#   endif
    ...
    initDAC((unsigned char*)i2s_outbuf, 1, 8000, BUFLEN);
    //SetOutWrPtr(0);
...
#       if 1 // Remove by Kuoping Hsu. 2005.07.07
    MMIO_Write(DrvDecode_Len, (short)(READBUF_SIZE));
    MMIO_Write(DrvDecode_BASE  , (short)( ((unsigned int)pInputBufferPtr) >> 16)   );   // add_h
    MMIO_Write(DrvDecode_BASE+2, (short)( ((unsigned int)pInputBufferPtr) & 0xffff));   // add_l
#       endif /* 1 */

#       ifdef DUMP_PCM_DATA
    MMIO_Write(DrvDecodePCM_Len   , (short)BUFLEN);
    MMIO_Write(DrvDecodePCM_BASE  , (short)(((unsigned int)&i2s_outbuf) >> 16));
    MMIO_Write(DrvDecodePCM_BASE+2, (short)(((unsigned int)&i2s_outbuf) & 0xffff));
#       endif
...
#   endif
        ...
        MMIO_Write(DrvDecode_Frame_Lo, (short)( ((unsigned int)(frame*((20<<16)/1000))) & 0xffff));
        MMIO_Write(DrvDecode_Frame_Hi, (short)( ((unsigned int)(frame*((20<<16)/1000))) >> 16)   );
#endif
