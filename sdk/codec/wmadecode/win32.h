...
///////////////////////////////////////////////////////////////////////////
    ...
    #define DrvDecode_Frame_Lo  6
    #define DrvDecode_Frame_Hi  8
...
MMP_INLINE int isDownSample(void);
MMP_INLINE void MMIO_Write(int reg, unsigned short val);
MMP_INLINE unsigned short MMIO_Read(int reg);
MMP_INLINE void SetOutWrPtr(int val);
MMP_INLINE int GetOutRdPtr(void);
MMP_INLINE int GetOutWrPtr(void);
MMP_INLINE void report_error(char *str);
