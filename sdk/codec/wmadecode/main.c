...
static void FillWriteBuffer(int nPCMBytes)
{
    ...
    {
#ifdef CFG_CPU_WB
        ithFlushDCacheRange((void*)(pcmWriteBuf + pcmWriteIdx), nPCMBytes);
        ithFlushMemBuffer();
#endif
        ...
        if(isMusicCodecDump()) {
            ...
            // else
            // {
                // uint32_t szsec0 = (I2SBUFSIZE/sizeof(short)) - pcmDumpIdx;
                // uint32_t szsec1 = nPCMBytes - szsec0;
                // i = szsec0;
                // while(i > 2048) {
                    // pcmDumpIdx += 2048;
                    // if(pcmDumpIdx == (I2SBUFSIZE/sizeof(short))) pcmDumpIdx = 0;
                    // i -= 2048;
                    // AudioPluginAPI(SMTK_AUDIO_PLUGIN_CMD_ID_PCMIDX);
                // }
                // if(i) {
