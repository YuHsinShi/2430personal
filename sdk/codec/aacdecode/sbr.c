...
static unsigned int* gBufSD= (unsigned int*)INTERNAL_SD;
static unsigned int* gBufSD2 = (unsigned int*)(INTERNAL_SD+4096);
#endif
/**************************************************************************************
...
#ifdef AAC_ENABLE_INTERNAL_SD
    psi->XbufTmp1 = (BufTemp*)gBufSD;
    psi->XbufTmp2 = (BufTemp*)gBufSD2;
#endif
