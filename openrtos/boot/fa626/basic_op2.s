...
ulog10_32:
	str r12,[r13,#-4]! @r0(n),r1(d),r2(r),r3(q),r12(t)
	clz r2,r0
	mov r1,r0,lsl r2
	mov r1,r1,lsl #1 @r1=d=n@q32
	rsb r0,r2,#31 @n@q26
	mov r2,r1,lsr #27 @r2=d[31:27]@q32
	ldr r12,=ulog2_table
	ldr r2,[r12,r2,lsl #3]! @2@32/(1+i/32)
	ldr r3,[r12,#4] @2@26*log2(1+i/32)
	mov r12,#0
	umlal r12,r2,r1,r2 @[r2,r12]=(1+d)@q32/a
	ldr r12,=0x55555555
	add r0,r3,r0,lsl #26
	smull r12,r3,r2,r12
	ldr r1,=0x05c551d9
