...
void ControlCurtain(int movement);//movement 0: close, 1: open, 2: stop
...
extern ITULayer* settingLayer;
extern ITULayer* curtainLayer;
extern ITULayer* scenesLayer;
extern ITUCoverFlow* settingCoverFlow;
extern ITUSprite* settingPageSprite;
