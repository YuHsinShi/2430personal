...
int SDL_main(int argc, char *argv[])
{
    ...
    ituSceneLoadFile(&scene, CFG_PRIVATE_DRIVE ":/curve.itu");
    ...
    curve = (ITUCurve*)ituSceneFindWidget(&scene, "Curve1");
    ...
    curve->yPoints[3] = 100;
    curve->pointCount = 4;
    ituWidgetUpdate(curve, ITU_EVENT_LAYOUT, 0, 0, 0);
