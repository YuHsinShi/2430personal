...
{
    ITUListBox* listbox = (ITUListBox*)widget;
    ITUText* item = (ITUText*) itcTreeGetChildAt(listbox, listbox->focusIndex);
...
int SDL_main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("ITU listbox2 Test",
    ...
    ituSceneLoadFile(&scene, CFG_PRIVATE_DRIVE ":/listbox2.itu");
