...
static ITULoadFunction loadFunctions[] =
{
    ITU_CUSTOM + 1, ituCustomTextLoad,
    0, NULL
};
...
int SDL_main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("ITU Custom Event Test",
    ...
    ituSceneSetLoadFunctionTable(&scene, loadFunctions);
    ituSceneLoadFile(&scene, CFG_PRIVATE_DRIVE ":/customwidget.itu");
