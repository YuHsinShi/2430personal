...
bool VideoPlayerUsbInsertedOnCustom(ITUWidget* widget, char* param)
{
	...
	{
		ITUListBox *listbox = (ITUListBox*)videoPlayerScrollMediaFileListBox;
		StorageType storageType = StorageGetCurrType();
		...
		ituSpriteGoto(videoPlayerStorageSprite, storageType);
		videoPlayerPageIndex = 1;
		videoPlayerFocusIndex = -1;
...
bool VideoPlayerRandomButtonOnPress(ITUWidget* widget, char* param)
{
	videoPlayerScrollMediaFileListBox->mflistbox.randomPlay = atoi(param);
    return true;
}
...
bool VideoPlayerLastButtonOnPress(ITUWidget* widget, char* param)
{
	...
	item = ituMediaFileListPrev((ITUMediaFileListBox*)videoPlayerScrollMediaFileListBox);
...
bool VideoPlayerNextButtonOnPress(ITUWidget* widget, char* param)
{
	...
	item = ituMediaFileListNext((ITUMediaFileListBox*)videoPlayerScrollMediaFileListBox);
...
#if (CFG_CHIP_FAMILY == 9850 || CFG_CHIP_FAMILY == 970 || CFG_CHIP_FAMILY == 9860) && (CFG_VIDEO_ENABLE)
