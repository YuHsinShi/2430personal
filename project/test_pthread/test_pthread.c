...
#ifdef CFG_DBG_TRACE
    traceString chn = xTraceRegisterString("thread");
#endif
...
#ifdef CFG_DBG_TRACE
    vTracePrintF(chn, "Test %d threads", n);
#endif
...
#ifdef CFG_DBG_TRACE
        vTracePrintF(chn, "Thread %d create", i);
#endif
...
#ifdef CFG_DBG_TRACE
        vTracePrintF(chn, "Thread %d join", i);
#endif
